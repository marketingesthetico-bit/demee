...
export default async function EditPage() {
  ...
  // Budget + booking are loaded read-only for preview accuracy only —
  // the editable config for each now lives under /leads · Ajustes and
  // /bookings · Ajustes respectively.
